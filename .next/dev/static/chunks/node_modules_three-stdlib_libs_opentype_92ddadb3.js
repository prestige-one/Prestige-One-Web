...
"[project]/node_modules/three-stdlib/libs/opentype.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const { parseBuffer } = /* @__PURE__ */ (()=>{
    ...
    Tokenizer.prototype.runContextCheck = function(contextParams) {
        ...
        this.contextCheckers.forEach(function(contextChecker) {
            ...
            if (!openRange && contextChecker.checkStart(contextParams)) {
                ...
                this$1$1.dispatch("contextStart", [
                    contextName,
                    index
                ]);
            }
        ...
        switch(substitutionType){
            case "11":
                return function(glyphIndex) {
                    return singleSubstitutionFormat1.apply(this$1$1, [
                        glyphIndex,
                        subtable
                    ]);
                };
            case "12":
                return function(glyphIndex) {
                    return singleSubstitutionFormat2.apply(this$1$1, [
                        glyphIndex,
                        subtable
                    ]);
                };
            case "63":
                return function(contextParams) {
                    return chainingSubstitutionFormat3.apply(this$1$1, [
                        contextParams,
                        subtable
                    ]);
                };
            case "41":
                return function(contextParams) {
                    return ligatureSubstitutionFormat1.apply(this$1$1, [
                        contextParams,
                        subtable
                    ]);
                };
            case "21":
                return function(glyphIndex) {
                    return decompositionSubstitutionFormat1.apply(this$1$1, [
                        glyphIndex,
                        subtable
                    ]);
                };
    ...
    Bidi.prototype.registerFeatures = function(script, tags) {
        ...
        var supportedTags = tags.filter(function(tag) {
            return this$1$1.query.supports({
                script,
                tag
            });
        });
...
//# sourceMappingURL=node_modules_three-stdlib_libs_opentype_92ddadb3.js.map